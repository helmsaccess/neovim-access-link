...
class SuggestionSoundCache:
    ...
    def _load(self, name, path, factory) -> None:
        try:
            ...
            self._diagnostic(
                self._PREFIX + "LoadError", cue=name,
    ...
    def play(self, cue: str) -> bool:
        ...
        try:
            ...
            self._diagnostic(
                "suggestionSoundPlayError", cue=cue,
                errorType=type(error).__name__, error=str(error),
            )
            return False
...
class SpellingSoundCache(SuggestionSoundCache):
    ...
    def play(self, cue: str = "error") -> bool:
        ...
        try:
            ...
            self._diagnostic(
                "spellingSoundPlayError", errorType=type(error).__name__, error=str(error),
            )
            return False
...
class EditorSoundCache(SuggestionSoundCache):
    ...
    _BUNDLED_FILES = {
        "delete": "delete.wav", "replace": "replace.wav",
        "lineStart": "lineStart.wav", "lineEnd": "lineEnd.wav",
        "fileStart": "fileStart.wav", "fileEnd": "fileEnd.wav",
