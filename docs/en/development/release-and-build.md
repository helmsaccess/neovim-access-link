...
pre-release identifier such as `0.95.1-dev.1` plus branch/commit metadata when
...
user-chosen product version is 0.95.1 and the configured release channel is
