...
pre-release identifier such as `0.95.0-dev.1` plus branch/commit metadata when
...
user-chosen product version is 0.95.0 and the configured release channel is
