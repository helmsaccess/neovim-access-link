...
pre-release identifier such as `0.94.2-dev.1` plus branch/commit metadata when
...
user-chosen product version is 0.94.2 and the configured release channel is
