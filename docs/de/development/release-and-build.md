...
Beta-Testbuild lautet daher `0.89.4`. Dieses rein numerische Dreierformat
...
- den Archivnamen `nvimNvdaAccess-0.89.4.nvda-addon`,
- den sichtbaren Komponentenpaketnamen
  `neovim-access-link-0.89.4-user.tar.gz`,
