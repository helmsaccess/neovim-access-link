...
| allgemeine Diagnostics | `vim.diagnostic`, `DiagnosticChanged`, native Diagnostic-Navigation und fünf Access-Link-Befehle | Quelle beziehungsweise Namespace, Schwere, optionaler Code, Bytebereich, Text, Index und Anzahl | vollständige Diagnose in Sprache/Braille; getrennte VS-Code-Earcons beim gezielten Betreten einer Fehler-/Warnungszeile oder eines exakten Bereichs; Tippen und Hintergrundänderungen stumm | ja | gehärteter Vertrag, Navigation, Speech und Klang-Gates; reale gepinnte nvim-lint-/ALE-Läufe für C, Python, Bash, Go, Rust, Ruby und Markdown sowie none-ls-LSP-Brücke auf Neovim 0.10.1/0.12.3; Windows/NVDA-Praxis offen |
