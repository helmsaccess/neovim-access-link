...
| Dateimanager | netrw-Dateisystemdaten beziehungsweise öffentliche Plugin-APIs | UTF-8-sicher bytebegrenzter Name, Pfad, Typ, Markierung, Baumstatus | Sprache und Braille | netrw, Oil, nvim-tree, Neo-tree, mini.files | echtes netrw, API-Attrappen sowie Zwei-/Vierbyte-, Grenz- und ungültige UTF-8-Fälle; reale Pluginaktionen und Hardware-Braille offen |
