...
local targets = {
  ...
  ["0001-neovim-integration-point.md"] = "#docs__de__development__adr__0001-neovim-integration-pointmd__adr-0001-hybrider-neovim-andockpunkt",
  ...
  ["adr/0005-contextual-exploration-input.md"] = "#docs__de__development__adr__0005-contextual-exploration-inputmd__adr-0005-kontextbezogene-eingabe-für-den-sprachexplorationsmodus",
  ["adr/0006-local-tcp-and-ssh-stdio-transports.md"] = "#docs__de__development__adr__0006-local-tcp-and-ssh-stdio-transportsmd__adr-0006-lokales-tcp-und-ssh-standardstreams-als-transporte",
  ["0006-local-tcp-and-ssh-stdio-transports.md"] = "#docs__de__development__adr__0006-local-tcp-and-ssh-stdio-transportsmd__adr-0006-lokales-tcp-und-ssh-standardstreams-als-transporte",
  ...
  ["component-installation.md"] = "#docs__de__development__component-installationmd__komponenteninstallation-und-ssh-stdio",
  ["testing.md"] = "#docs__de__development__testingmd__teststrategie",
  ["human-testing.md"] = "neovim-access-link-human-testing-de.html",
  ["accessibility.md"] = "#docs__de__development__accessibilitymd__funktions--und-accessibility-matrix",
  ["release-and-build.md"] = "#docs__de__development__release-and-buildmd__release--versions--und-buildprozess",
  ["nvda-2026.1-api-notes.md"] = "#docs__de__development__nvda-20261-api-notesmd__nvda-api-grenzen",
  ...
  ["dependencies.md"] = "#docs__de__development__dependenciesmd__abhängigkeiten",
  ["plan.md"] = "#docs__de__development__planmd__aktiver-plan",
  ["changelog.md"] = "#docs__de__development__changelogmd__changelog",
  ["changelog-history.md"] = "https://github.com/helmsaccess/neovim-access-link/blob/main/docs/de/development/changelog-history.md",
